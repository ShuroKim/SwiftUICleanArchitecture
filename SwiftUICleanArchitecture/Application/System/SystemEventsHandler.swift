...
protocol SystemEventsHandler {
    ...
    func handlePushRegistration(result: Result<Data, Error>)    // 토큰 갱신관련?
    func appDidReceiveRemoteNotification(payload: NotificationPayload, fetchCompletion: @escaping FetchCompletion)   // 원격푸시 받을때?
}
